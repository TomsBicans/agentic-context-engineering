...
def _run_record(run: RunResult, analysis: AnalysisResult | None) -> dict[str, Any]:
    ...
    return {
        ...
        "exact_match": analysis.exact_match if analysis else None,
        "f1": analysis.f1 if analysis else None,
        "precision": analysis.precision if analysis else None,
        "recall": analysis.recall if analysis else None,
